...
from her import DDPG


def parse_arguments():
    parser = argparse.ArgumentParser(description='DDPG Argument Parser')
    parser.add_argument('--state', dest='state_size', type=int, default=38)
    ...
    parser.add_argument('--log', dest='log', type=str,
                        default="/Users/zhengluo/Google Drive/10703 DRL/project/anding/ddpg_v2/ddpg/her_log/log.csv")
    parser.add_argument('--act-save', dest='actor_save', type=str,
                        default="/Users/zhengluo/Google Drive/10703 DRL/project/anding/ddpg_v2/ddpg/her_actor/actor.h5")
    parser.add_argument('--cri-save', dest='critic_save', type=str,
                        default="/Users/zhengluo/Google Drive/10703 DRL/project/anding/ddpg_v2/ddpg/her_critic/critic.h5")
